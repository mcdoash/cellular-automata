...
const Presets = {
   ...
   * @member {Array.<object>} Presets.automata
   * @property {string} name the name of the automata
   * @property {Function} generate the automata generation function
   */
  automata: [
    {
      name: 'Cave Generation',
      generate: caveGeneration
    },
    {
      name: 'Game of Life',
      generate: gameOfLife
    ...
    {
      name: 'Design',
      generate: designAutomata
    }
  ],
  /**
   * Helper functions for creating preset automata
   * @member {Array.<Function>} Presets.helpers
   */
  helpers: {
    setBoundaryWalls
  }
